...
warExtendedManagerList = {}
warExtendedManagerList.__index = warExtendedManagerList


function warExtendedManagerList.New (copySource)
  local obj = {}
  setmetatable (obj, warExtendedManagerList)
