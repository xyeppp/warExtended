...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <UiMod name="warExtended Terminal Toolbar" version="2.0" date="21/10/22">
        ...
        <Files>
            ...
            <File name="Tools/ObjectInspector/Window.lua"/>-->

            <File name="Tools/SoundPlayer/Window.xml"/>
            <File name="Tools/SoundPlayer/Core.lua"/>
            <File name="Tools/SoundPlayer/Window.lua"/>
            ...
            <File name="Tools/TextureViewer/TextureSlices.lua"/>
            <File name="Tools/TextureViewer/Textures.lua"/>
            <File name="Tools/TextureViewer/Window.lua"/>

         <!--   <File name="Tools/Timer/Window.xml"/>
            <File name="Tools/Timer/Core.lua"/>
            <File name="Tools/Timer/Window.lua"/> -->
