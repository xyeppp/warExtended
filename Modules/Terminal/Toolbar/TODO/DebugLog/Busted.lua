...
function BustedGUI.NewErrorRecorded(addonName)
    ...
    if not DoesWindowExist("BustedMiniGUIText") then return end
    if not DoesWindowExist("BustedMiniGUI") then return end
    ...
    LabelSetText("BustedMiniGUIText", towstring(Busted.errorCount)..L" errors")
    ...
    if not BustedGUI.alertActive then
        ...
        LabelSetTextColor("BustedMiniGUIText", 255, 0, 0)
        WindowStartAlphaAnimation("BustedMiniGUIText",
...
function BustedGUI.ToggleMainWindow()
    ...
    WindowUtils.ToggleShowing("BustedGUI")
...
function BustedGUI.ClearAlertFlash()
    ...
    WindowStopAlphaAnimation("BustedMiniGUIText")
    WindowSetShowing("BustedMiniGUIText", true)
    WindowSetAlpha("BustedMiniGUIText", 1.0)
    LabelSetTextColor("BustedMiniGUIText", 0, 204, 0)

end

function Busted.Initialize()
    warExtendedTerminal:RegisterToolbarItem(L"Busted", L"Better error reporting for addons", "BustedGUI", 04673)
...
function BustedGUI.Initialize()
    ...
    CreateWindow("BustedMiniGUI", true)
    LabelSetText("BustedMiniGUIText", L"No errors")
    ...
    LayoutEditor.RegisterWindow("BustedMiniGUI", L"Busted", L"Busted Mini Alert", false, false, true, nil)
