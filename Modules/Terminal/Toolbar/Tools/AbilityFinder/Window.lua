...
local TITLEBAR = 6
    ...
    local SEARCH_BOX = SearchEditBox:Create(WINDOW_NAME.."AbilitySearch", TerminalAbilityFinder:GetSettings().abilityCache)
    ...
    function SEARCH_LIST.OnTextChangedSearch(searchResults)
      p("setting")
      SEARCH_LIST:SetDisplayOrder(searchResults, function(a,b) return a<b  end)
    end
