...
local SEARCH_FRAME = SearchEditBox:Create(WINDOW_NAME .. "OutputAdvancesSearch")
...
local searchFilters = {
    ...
    purchased = {
        ...
        match = function(self, item, operator, num)
            ...
            return SEARCH_FRAME:Compare(operator, purchased, num)
        end
    },
}
...
function LOG_BUTTON_FRAME:OnLButtonUp()
    TerminalLogViewer.AddExternalLog(ADVANCES_FRAME:GetDataTable())
...
function ADVANCES_FRAME:SetRowDefinition()
    ...
    local labelData = {
        ...
        ["Details1"] = {
            ...
            callback = function(self, index)
                local advanceData = TerminalCareerCacher:GetSettings().advanceData[index]
                local identifierText = L"CC " ..
                advanceData.category .. L", tier " .. advanceData.tier .. L", ID " .. advanceData.packageId
        ...
        ["Details2"] = {
            ...
            callback = function(self, index)
                local advanceData = TerminalCareerCacher:GetSettings().advanceData[index]
                local purchaseText = L"" ..
                advanceData.timesPurchased ..
                L"/" ..
                advanceData.maximumPurchaseCount ..
                L": Min LeveL" .. advanceData.minimumRank .. L", Min Renown " .. advanceData.minimumRenown
