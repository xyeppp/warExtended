...
--TODO: change savedVar pos from terminal to toolbar?; TerminalLogViewer.AddExternalLog(logObjects) change
...
function TerminalLogViewer.AddExternalLog(logObjects)
  DialogManager.MakeDoubleTextEntryDialog(L"Add Log", L"Log name:", L"", L"Log objects:\n(Separate objects by ;)", warExtended:toWString(logObjects), TerminalLogViewer.AddLog, nil, nil, nil)
end
