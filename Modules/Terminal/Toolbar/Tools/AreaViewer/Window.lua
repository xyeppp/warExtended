...
function CIRCLE_ICON:OnMouseOver(...)
    EA_Window_WorldMap.CreateAppropriateZoneTooltip(self:GetId(), Tooltips.ANCHOR_WINDOW_LEFT)
end
...
function CIRCLE_ICON:UpdateControlIcon()
    ...
    local currentPairing = EA_Window_WorldMap.currentPairing
    ...
    EA_Window_WorldMap.currentPairing = currentPairing
end
