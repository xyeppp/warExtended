...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" >
    ...
    <UiMod name="warExtended Interaction" version="1.5" date="11/6/2009" >
        ...
        <Files>
            ...
            <File name="Healer/Source/InteractionHealerWindow.xml" />
            <File name="Healer/Source/InteractionHealerWindow.lua" />

            <File name="Renown/Source/InteractionRenownTraining.lua" />
            <File name="Renown/Source/InteractionRenownTraining.xml" />
            <File name="Renown/Core.lua" />
            <File name="Renown/RenownAbilityTypes.lua" />
            <File name="Renown/Templates.xml" />
            <File name="Renown/Window.xml" />
            <File name="Renown/Window.lua" />
        ...
        <SavedVariables>
            ...
            <SavedVariable name="warExtendedInteraction.Settings" />
        </SavedVariables>
