...
function UiModWindow.ShouldShowType(modData)
    return ShouldShowType(modData)
end

function UiModWindow.ShouldShowCategory(modData)
    return ShouldShowCategory(modData)
end

function UiModWindow.CompareMods(index1, index2)
    return CompareMods(index1, index2)
end
