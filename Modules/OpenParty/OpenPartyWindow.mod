...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" >
    ...
    <UiMod name="warExtended Open Party" version="1.0" date="08/30/2021" >
        ...
        <Files>
            ...
            <File name="Original/Source/OpenPartyWindowTabLootRollOptions.xml" />
            <File name="Original/Source/OpenPartyWindowTabManage.xml" />
            <File name="Original/Source/OpenPartyWindow.xml" />
