...
function LogDisplay:SetFilterColor(logName, filterId, color)
  LogDisplaySetFilterColor(self:GetName(), logName, filterId, warExtended:UnpackRGB(color))
end
...
function LogDisplay:GetStringFromCursorPos(x, y)
  return LogDisplayGetStringFromCursorPos(self:GetName(), x, y)
end

function LogDisplay:SetTextEntryLimit(entryLimit)
  LogDisplaySetTextEntryLimit(self:GetName(), entryLimit)
end
