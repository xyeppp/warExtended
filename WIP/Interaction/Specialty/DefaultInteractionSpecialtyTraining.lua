...
function EA_Window_InteractionSpecialtyTraining.IncrementSpecialization()
    ...
    then
        local tab = WindowGetId(WindowGetParent(SystemData.MouseOverWindow.name))
        EA_Window_InteractionSpecialtyTraining.selectedSpecializationLevels[tab]
            = EA_Window_InteractionSpecialtyTraining.selectedSpecializationLevels[tab]  + 1
        
        --EA_Window_InteractionSpecialtyTraining.RefreshInteractivePane()
        --EA_Window_InteractionSpecialtyTraining.RefreshDisplayPane()
        warExtendedSpecialtyTraining.RefreshInteractivePane()
    end
end
...
function EA_Window_InteractionSpecialtyActionAbility:SetPurchased()
    ...
    EA_Window_InteractionSpecialtyTraining.selectedAdvances[WindowGetId(WindowGetParent(self:ParentGetName()))][self.m_AdvanceData.packageId] = nil
end
...
function EA_Window_InteractionSpecialtyActionAbility:SetSelected()
    ...
    EA_Window_InteractionSpecialtyTraining.selectedAdvances[WindowGetId(WindowGetParent(self:ParentGetName()))][self.m_AdvanceData.packageId] = self.m_AdvanceData
end
