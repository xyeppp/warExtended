...
function MiniReport.ToggleAlert()
    MiniReport.Settings.IsAlert = not MiniReport.Settings.IsAlert
    MiniReport:PrintToggle("War Report cooldown alert is ", not MiniReport.Settings.IsAlert)
end
